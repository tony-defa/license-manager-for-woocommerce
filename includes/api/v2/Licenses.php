...
class Licenses extends LMFWC_REST_Controller {
	...
	public function activateLicense( WP_REST_Request $request ) {
		...
		return $this->response( true, $licenseData, 'v2/licenses/activate/{license_key}/{activation_count}' );
	}
	...
	public function deactivateLicense( WP_REST_Request $request ) {
		...
		return $this->response( true, $licenseData, 'v2/licenses/deactivate/{license_key}/{deactivation_count}' );
	}
